...
def get_opts():
    ...
    parser.add_argument('--filter-scales', nargs='+', type=float,
                        default=[1, 2,4], #filter [1,2,4]
                        help='a list of scales for all the filters')
    parser.add_argument('--K', type=int, default=95, # k=10
                        help='# of words')
    parser.add_argument('--alpha', type=int, default=35, #alpha 25
                        help='Using only a subset of alpha pixels in each image') 

    ## Recognition system (requires tuning)
    parser.add_argument('--L', type=int, default=2, #l=2
